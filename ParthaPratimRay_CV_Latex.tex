...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Ray. P. P., Pradhan, M. P., "SanicLLMPiAB: Sanic Web Framework on Raspberry Pi for Localized LLMs for Apache Benchmark Analysis", SN Computer Science, Springer, 2026, ISSN: 2661-8907, DOI:   (Scopus Index) (CF: 5.8) (Accepted)
...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Special Session Chair on "Internet of AI Things (IoAT): Intelligent, Edge-Aware, and Autonomous Sensor Ecosystems for Image Processing and Next-Generation Smart Environments" at 15th International Conference on Image Processing Theory, Tools and Applications (IPTS 2026), December 16-19, 2026, Kolkata, India.

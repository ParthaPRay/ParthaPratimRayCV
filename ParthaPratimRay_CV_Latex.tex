...
\begin{tabular}{p{7cm}p{9cm}}
	...
	\hline
	SCI Journals& 126 publications in SCI-indexed journals \\
	SSCI Journals& 1 publication in SSCI-indexed journal \\
	Scopus Journals& 29 publications in Scopus-indexed journals \\
...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Ray. P. P. "Reliability-by-Design for Agentic GenAI: Turning the AI Risk Atlas into an EU AI Act–Ready Assurance Case", IEEE Reliability Magazine, IEEE, 2026, ISSN: 2641-8819, DOI: 
		
		\item Ray. P. P. "A Review of TRiSM Frameworks in Artificial Intelligence Systems: Fundamentals, Taxonomy, Use Cases, Key Challenges and Future Directions", Expert Systems, Wiley, 2026, ISSN: 1468-0394, DOI: 10.1111/exsy.70213 (Science Citation Index) (IF: 2.3) 
...
\begin{adjustwidth}{6em}{0pt}
	...
	\item Mohammed, A. M., Khan, AT., Khan, A., Cao, X., Ray, P. P., Li, S., “LLMQDelivery: An LLM-Guided Autonomous Quadcopter Delivery System for Minimizing Human Contact in Quarantine Zone Logistics”, In 6th IEEE Conference on Cybernetics, Nanjing, Jiangsu Province, China, April 17-20, 2026. DOI: 
...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Ray. P. P., “Pattern Recognition and Machine Learning: Concepts, Mathematics, and Intuitions”, Renu Publishers, ISBN: 978-93-92597-98-5, 2026.
...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Delivered talk on “Internet of AI Things: Enabling generative LLMs at the Edge of Pervasive Systems” at SR  University, Telangana on 29 November, 2025.
...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Development and Performance Analysis of 4GLTE Protocol based Communication System On-board Vehicle for Monitoring Environment by Satwik Shreshth (MCA) with co-guidance by Dr. Ravi Kant Jain, CSIR-CMERI, Durgapur, 2025 Even.
		
		\item 	Development of AI based Multi Object Detection System by Suveer Kumar (MCA) with co-guidance by Dr. Ravi Kant Jain, CSIR-CMERI, Durgapur, 2025 Even.
		
		
		\item Retrieval Augmented Question-Answering on Indian Constitution and Indian Penal Code by Mayel Lyangten Lepcha, Pratiksha Phukon, Yogesh Lokhar, 2024 Odd.
...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Special Issue on “Internet of AI Things (IoAT): Agentic Smart Computing for Human-Centric and Sustainable Intelligent Systems”, at 8th International Conference on Smart Computing and Informatics (SCI-2026), 28-29 April 2026, Swinburne Vietnam, Hanoi Location. 
		\item Special Issue on “Internet of AI Things (IoAT): Mathematical Foundations, Edge Intelligence, and Computational Paradigms”, at International Conference on Mathematical Sciences and Computational Intelligence (ICMSCI-2026), February 20–22, 2026, Department of Mathematics, P.G.D.A.V. College, University of Delhi.
		
		\item Special Issue on “Pervasive Biomedical Informatics”, Frontiers of Bioinformatics, 2026, Frontiers co-edited by Rahula Singh Jasrotia, Wei Lan, Lihong Peng, and Manor Kandpal.

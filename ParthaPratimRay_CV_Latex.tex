...
\section{\textbf{Design Patents Filed}}

\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		
		\item AI-BASED LOCALIZED EDGE-IOT RELIABILITY ASSESSMENT DEVICE. (Application Number: 509843-001), Inventor: Ray. P. P., 2026.
		
		\item LOCALIZED AI-BASED LARGE LANGUAGE MODEL ENABLED DEVICE WITH IoT SPECTROMETER SENSOR FOR LEAF QUALITY ASSESSMENT. (Application Number: 509848-001), Inventor: Ray. P. P., 2026.

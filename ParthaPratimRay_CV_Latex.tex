...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Ray. P. P., Pradhan, M. P., "SanicLLMPiAB: Sanic Web Framework on Raspberry Pi for Localized LLMs for Apache Benchmark Analysis", SN Computer Science, Springer, 2026, ISSN: 2661-8907, DOI: 10.1007/s42979-026-05175-2 (Scopus Index) (CF: 5.8) (Accepted)
		...
		\item Ray. P. P., "Reflections on the Use of LLMs for Cell Annotation", Briefings in Bioinformatics, Oxford Academic, 2026, ISSN: 1477-4054, DOI: 10.1093/bib/bbag312   (Science Citation Index) (IF: 7.7) (Accepted)
		
		\item Ray. P. P., "Broadening the Evaluation of AI Tools in Medical Education: Beyond ChatGPT-5 Toward Multi-Model and Open-Source LLM Assessment", Updates in Surgery, Springer, 2026, ISSN: 2038-3312, DOI: 10.1007/s13304-026-02712-9  (Science Citation Index) (IF: 2.3) (Accepted)
...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Special Session Chair on " Internet of AI Things (IoAT) for Intelligent Image, Vision, and Computing Systems" at 11th International Conference on Image, Vision and Computing (ICIVC 2026), July 17–19, 2026, 2026, Kunming, the Spring City of China.

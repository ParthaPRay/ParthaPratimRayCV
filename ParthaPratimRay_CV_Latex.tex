...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Development of a Low-Cost Autonomous Drone for Emergency Medical delivery by Tashi Thenlay Lepcha (MCA), 2025, Even Semester.
		
		\item Development and Performance Analysis of 4GLTE Protocol based Communication System On-board Vehicle for Monitoring Environment by Satwik Shreshth (MCA) with co-guidance by Dr. Ravi Kant Jain, CSIR-CMERI, Durgapur, 2025, Even Semester.
		
		\item 	Development of AI based Multi Object Detection System by Suveer Kumar (MCA) with co-guidance by Dr. Ravi Kant Jain, CSIR-CMERI, Durgapur, 2025, Even Semester.
		...
		\item Implementation of Embedded Web Server using Internet of Things-based Tools by Hissey Ongmu Bhutia, Jayanti Banerjee, and Md. Mustaq Ansari, 2019, Odd Semester.

...
\begin{adjustwidth}{6em}{0pt}
	\begin{enumerate}
		...
		\item Ray. P. P., Pradhan, M.P., "An Evaluation Framework for Measuring Prompt Wise Metrics for Large Language Models in Resource-Constrained Edge ", BenchCouncil Transactions on Benchmarks, Standards and Evaluations, Elsevier, 2025, ISSN: 2772-4859, DOI: (Scopus) (CF: 16) (Accepted)
		
		\item	Ray. P. P., "Physical AI: Bridging the Sim-to-Real Divide Toward Embodied, Ethical, and Autonomous Intelligence", Machine Learning for Computational Science and Engineering, Springer, 2025, ISSN: 3005-1436, DOI: (Accepted)
		
		\item Ray. P. P., Pradhan, M.P., "Performance Analysis of Localized Large Language Models in Resource-Constrained Edge for Python and Rust APIs”, Journal of Edge Computing, Academy of Cognitive and Natural Sciences, 2025, ISSN: 2837-181X, DOI: (Scopus) (CF: 7.6) (Accepted)
